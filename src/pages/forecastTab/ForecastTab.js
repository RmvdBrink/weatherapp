...
import {TempContext} from "../../context/TempContextProvider";
        ...
        async function fetchForecasts() {
            ...
            try {
                ...
                const response = await
                    axios.get(`https://api.openweathermap.org/data/2.5/forecast?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=${process.env.REACT_APP_API_KEY}&lang=nl`);
    ...
    return (
        <div className="tab-wrapper">
            {loading &&
            <span>Er is iets misgegaan met het ophalen van data</span>
            }
      ...
      Zoek eerst een locatie om het weer voor deze week te bekijken
            ...
            {error &&
            <span> Er is iets mis gegaan met het ophalen van de data
            </span>
            }
            ...
            <span>
              {kelvinToMetric(singleForecast.main.temp)}&deg;
            </span>
